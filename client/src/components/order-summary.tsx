    ...
    <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
      <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-gray-500">Order details and shipping information.</p>
        </div>
        <div>
      ...
      <div className="border-t border-gray-200">
        <dl>
          ...
          <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{formatDate(order.orderDate)}</dd>
          </div>
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          {order.trackingNumber && (
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 font-mono">
                <a href="#" className="text-primary hover:text-blue-700">{order.trackingNumber}</a>
              </dd>
            </div>
          )}
        </dl>
